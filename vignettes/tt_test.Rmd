...
You also can gather all results into a single dataframe -- which lets you use a wide range of tools for data manipulation and visualization.
...
tt_df %>% 
  ...
  summarize(total_stem_count = sum(stem_count))
```
